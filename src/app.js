...
const cultureRouter = require("./router/culture.router.js")
const freshRouter = require("./router/fresh.router.js")
const exportRouter = require("./router/export.router.js")
app.use("/", viewsRouter)
